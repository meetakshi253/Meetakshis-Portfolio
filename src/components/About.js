...
function About() {
    ...
    var lab = <a className="link about-content-link" id="about-sbilab-link" href="http://sbilab.iiitd.edu.in">Visual Cognition Lab</a>
            ...
            <div className="container">
                ...
                <div className="container-message">
                    ...
                    <p className="container-message-details">
                        ...
                        I dabble in web development and possess a great interest in all things Neuroscience. Currently, I am working as a researcher at {lab} at IIIT Delhi. 
